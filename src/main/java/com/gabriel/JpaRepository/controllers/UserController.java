package com.gabriel.JpaRepository.controllers;
...
import com.gabriel.JpaRepository.repositories.UserRepository;

@RestController
@RequestMapping(value = "/users")
public class UserController {

	/* Injetando uma instancia desse objeto forma transparente */
	@Autowired
